...
% Tamano y posicion del logo dentro del margen superior
\newlength{\altologo}      \setlength{\altologo}{15mm}
\newlength{\margensuplogo} \setlength{\margensuplogo}{7mm}  % desde el borde del papel
\newlength{\margenlatlogo} \setlength{\margenlatlogo}{18mm} % desde el borde izq/der

% Espacio extra sobre el titulo para que no choque con el logo.
% Ponlo en 0mm si tu logo es pequeno y sobra aire.
\newcommand{\bajartitulo}{\vspace*{8mm}}

%=======================================================================
%  2. MAQUINARIA DEL ENCABEZADO CON LOGO  (no necesitas tocar esto)
%=======================================================================
\newlength{\anchoencabezado}
\setlength{\anchoencabezado}{\dimexpr\paperwidth-2\margenlatlogo\relax}
\newlength{\bajadalogo}          % desplazamiento vertical del encabezado
\setlength{\bajadalogo}{-\margensuplogo}
\addtolength{\bajadalogo}{-\altologo}
\newlength{\altocajareserva}     % alto util del recuadro de reserva
...
% Bloque logo (izquierda) + datos institucionales (derecha),
% dibujado en el margen superior SOLO de la primera pagina.
\newcommand{\encabezadoinstitucional}{%
  \AddToShipoutPictureBG*{%
    \AtPageUpperLeft{%
      \raisebox{\bajadalogo}{%
        \makebox[\paperwidth][c]{%
          \begin{minipage}{\anchoencabezado}%
            \noindent\cajalogo\hfill
            \parbox[b][\altologo][c]{0.60\anchoencabezado}{%
...
% falta en lugar de detener la compilacion. Cuando ya tengas todas las
% imagenes puedes cambiarlo por \includegraphics[width=...]{...} normal.
\newcommand{\imagen}[2]{%
  \IfFileExists{#2}%
...
% Para pasar el logo a la DERECHA y el texto a la IZQUIERDA:
% intercambia \cajalogo y el \parbox dentro del minipage de arriba
% (y cambia \raggedleft por \raggedright).
...
\begin{figure*}[!t]
  \centering
  % Sustituye por la captura del diagrama ladder completo
  \imagen{0.86\textwidth}{figuras/diagrama-ladder.png}
