...
% [p] = pagina propia de flotantes. Para un diagrama grande es mejor que
% [!t]: el "!" manda ignorar los limites de tamano de flotante, asi que un
% figure* mas alto que la pagina deja espacio negativo para el texto y se
% le encima. Si ademas quieres que salga al FINAL del documento, mueve
% este bloque entero detras de la bibliografia: un flotante nunca puede
% salir antes del punto donde se define.
\begin{figure*}[p]
  \centering
  ...
  % El tope de altura por defecto (0.80\textheight) impediria llegar a ese
  % ancho si la captura es alta: aqui se sube al maximo que admite un
  % flotante junto con su pie.
  \renewcommand{\altomaximagen}{0.85\textheight}%
...
% --- ALTERNATIVA: pagina completa en horizontal ------------------------
% Si el ladder es mas alto que ancho, ni siquiera al ancho del papel se
% ve bien: la proporcion manda y la imagen se queda pequena. En ese caso
% borra el figure* de arriba y descomenta este bloque, que gira la
% figura y le da toda la pagina (el paquete rotating ya esta cargado).
% Ojo: dentro de una figura girada los ejes se intercambian, por eso el
% ancho se mide con \textheight y el alto con \textwidth.
%
% \begin{sidewaysfigure*}
%   \centering
%   \includegraphics[width=0.95\textheight,height=0.88\textwidth,%
%                    keepaspectratio]{figuras/diagrama-ladder.png}
%   \caption{Diagrama de escalera del circuito de mando. Cada renglón
%   corresponde a una de las ecuaciones lógicas planteadas.}
%   \label{fig:ladder}
% \end{sidewaysfigure*}
